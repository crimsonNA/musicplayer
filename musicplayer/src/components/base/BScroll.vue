<template>
    <div>
        ...
        <div class="bscroll_content" :style="{ top: top, bottom: bottom }">
                    ...
                    >
                        ...
                        <div class="lists">
                            <p v-for="(k, i) in item.data" :key="i">
                                <!-- <img
                                    src="http://p2.music.126.net/uMj37iaDgTNfbfpEizfdRA==/109951164501569604.jpg"
                                    alt=""
                                /> -->
...
.bscroll_content .left {
    display: none;
    flex: 0 0 80px;
    background-color: #98e0ad;
}
.bscroll_content .left li {
    width: 100%;
    text-align: center;
}
.bscroll_content .left li.current span {
    color: #007aae;
    font-weight: bold;
    font-size: 16px;
    background-color: #c8efd4;
}
.bscroll_content .left li span {
    display: block;
    height: 100px;
    line-height: 100px;
    font-size: 14px;
}
.bscroll_content .right {
    flex: 1;
}
// .bscroll_content .right li {
//      min-height: 667px;
// }
.bscroll_content .right h2 {
    height: 18px;
    width: 100%;
    line-height: 18px;
    text-indent: 10px;
...
.bscroll_content .right .lists {
    background-color: #f2f3f4;
}
.bscroll_content .right .lists p {
    height: 64px;
    line-height: 64px;
    margin: 0 5px;
    border-bottom: 1px solid #e4e5e5;
}
.bscroll_content .right .lists p img {
    width: 45px;
    height: 45px;
    margin-top: 4px;
    margin-right: 16px;
